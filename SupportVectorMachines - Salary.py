...
salary_train=pd.read_csv("file:///C:\\Users\\Minal\\Downloads\\SalaryData_Train(1).csv")
salary_test=pd.read_csv("file:///C:\\Users\\Minal\\Downloads\\SalaryData_Test(1).csv")
