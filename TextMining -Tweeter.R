...
library(base64enc)
# authentication
user <- OAuthFactory$new(consumerKey="jhFUevOuw2glIVtWgjUFqEmvz",
                         consumerSecret="9Upeqal4HgVTZij19lvxHdlpL7eaLnvLvVwqIpI7wxsChX79oa",#fill ur's consumer API secret key
...
setup_twitter_oauth("jhFUevOuw2glIVtWgjUFqEmvW",#consumer API key
                    "9Upeqal4HgVTZij19lvxHdlpL7eaLnvLvVwqIpI7wxsChX79oa",#consumer secret key
                    "1167860865351110656-qhusqQ5wjDpdWVjD0qEGxv4L5imzMt",#access token 
                    "G4xbuTlMf4pv1xmzwm2KlaaTamKMYd5ZCuHijwBOathna")#access token secret
